    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <el-card shadow="hover" class="mgb20" style="height:252px;">
          <div class="user-info">
            <img src="../assets/image/img.jpg" class="user-avator" alt />
      ...
      <el-col :span="16">
        ...
        <el-card shadow="hover" style="height:403px;">
          ...
          <!--:show-header="false" 这里表格加这个属性会报错  
                        bug 详情见 https://github.com/ElemeFE/element/issues/17367
          -->
          <el-table :data="todoList" height="304" style="width: 100%;font-size:14px;">
